...
| OpenClaw bastion gateway image update | `30 8 * * *` Asia/Seoul | yes | `bash /host/app/openclaw-docker/cronjobs/update-openclaw-gateway-image` from the Docker gateway |
